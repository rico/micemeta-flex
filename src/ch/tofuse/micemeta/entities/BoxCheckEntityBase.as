package ch.tofuse.micemeta.entities {
	...
	public class BoxCheckEntityBase extends EventDispatcher {
		...
		public function set box(value:Box):void { (value) ? value.flextrine::addValue('box_checks', this) : ((_box) ? _box.flextrine::removeValue('box_checks', this) : null); _box = value; }
		private var _box:Box;
		
		[Association(side="owning", oppositeAttribute="box_checks", oppositeCardinality="*")]
		public function get nestcheck():NestCheck { checkIsInitialized("nestcheck"); return _nestcheck; }
		public function set nestcheck(value:NestCheck):void { (value) ? value.flextrine::addValue('box_checks', this) : ((_nestcheck) ? _nestcheck.flextrine::removeValue('box_checks', this) : null); _nestcheck = value; }
		private var _nestcheck:NestCheck;
		
		public function BoxCheckEntityBase() {
